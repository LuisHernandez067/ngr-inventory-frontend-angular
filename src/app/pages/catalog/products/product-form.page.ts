...
@Component({
  ...
  template: `
    <div class="page-header">
      ...
      <h1 class="page-title">{{ isEdit() ? 'Editar' : 'Nuevo' }} producto</h1>
    </div>
        ...
        <mat-card-content>
          ...
          <form [formGroup]="form" (ngSubmit)="submit()" novalidate class="form-grid">
            <mat-form-field appearance="outline">
              ...
              @if (fieldError('sku')) {
                <mat-error>{{ fieldError('sku') }}</mat-error>
              }
            </mat-form-field>
            ...
            <mat-form-field appearance="outline">
              ...
              @if (fieldError('categoryId')) {
                <mat-error>{{ fieldError('categoryId') }}</mat-error>
              }
            </mat-form-field>

            <mat-form-field appearance="outline">
              <mat-label>Unidad de medida</mat-label>
              <input matInput formControlName="unit" placeholder="kg, unidad, caja..." />
              @if (fieldError('unit')) {
                <mat-error>{{ fieldError('unit') }}</mat-error>
              }
            </mat-form-field>
            ...
            <mat-form-field appearance="outline">
              ...
              @if (fieldError('minStock')) {
                <mat-error>{{ fieldError('minStock') }}</mat-error>
              }
            </mat-form-field>
...
export class ProductFormPage implements OnInit {
  ...
  private loadCategories(): void {
    this.categoryService.getAll({ page: 1, pageSize: 100 }).subscribe({
